...
Public Class Leave_Certificate
    ...
    Private Sub Leave_Certificate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        fillcombo()
    ...
    Private Sub NewRecord_Click(sender As Object, e As EventArgs) Handles NewRecord.Click
        Dim rpt As New Report_Leave 'The report you created.
        rpt.SetParameterValue("p1", txtpname.Text)
        rpt.SetParameterValue("p2", DateTimePicker2.Text)
        rpt.SetParameterValue("p3", DateTimePicker3.Text)
        rpt.SetParameterValue("p4", txtdisease.Text)
        rpt.SetParameterValue("p5", DateTimePicker4.Text)
        rpt.SetParameterValue("p6", txtname.Text)
        rpt.SetParameterValue("p7", txtquali.Text)
        rpt.SetParameterValue("p8", txtreg.Text)
        rpt.SetParameterValue("p9", txtadd.Text)
        rpt.SetParameterValue("p10", txtmob.Text)
